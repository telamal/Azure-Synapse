...
synapse_azure_ad_admin_upn               = "cloudtrainingmadeeasy_hotmail.com#EXT#@cloudtrainingmadeeasyhotmai.onmicrosoft.com"   // UserPrincipcalName (UPN) for the Azure AD administrator of Synapse. This can also be a group, but only one value can be specified. (i.e. shane@microsoft.com)
